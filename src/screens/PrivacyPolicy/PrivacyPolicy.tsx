...
export const PrivacyPolicy: React.FC = () => (
  <ScrollView>
    <View style={styles.container}>
      ...
      <P>We do not require the collection of any information to use the site or apps.</P>
      <P>
        You may optionally add an email address which is used to send you occasional email updates.
        You may unsubscribe at any time. In order to facilitate email messages, your email address
        may be shared with services used to send email, including:
      </P>
      ...
      <P>
        We use local storage on the site or app to retain your preferences. This storage is not
        connected to any personally identifiable information.
      </P>
      <P>
        We or our hosting provider may also store basic technical information, such as your IP
        address, in temporary memory or logs.
      </P>
      <H3>ANALYTICS</H3>
      <P>
        The site and app collects aggregate, anonymous statistics, such as the percentage of users
        who use particular features, to improve the app.
      </P>
      <P>
        The app or site may use the following third party services for anonymous analytics tracking:
      </P>
      <PLink link={ExternalLinks.NetlifyPrivacyPolicy}>Netlify</PLink>
      <PLink link={ExternalLinks.GoogleAnalyticsPrivacy}>Google Analytics</PLink>
      <PLink link={ExternalLinks.FirebaseAnalyticsPrivacy}>Firebase Analytics</PLink>
      <H3>INFORMATION USAGE</H3>
      <P>
        We use the information we collect to operate and improve our website, apps, and support.
      </P>
      <P>
        We do not share personal information with outside parties except to the extent necessary to
        accomplish the app’s functionality. We may share anonymous, aggregate statistics with
        outside parties.
      </P>
      <P>
        We may disclose your information in response to subpoenas, court orders, or other legal
        requirements; to exercise our legal rights or defend against legal claims; to investigate,
        prevent, or take action regarding illegal activities, suspected fraud or abuse; or to
        protect our rights and property.
      </P>
      <H3>SECURITY</H3>
      <P>
        We implement a variety of security measures to help keep your information secure. For
        instance, all communication with the app and website requires HTTPS.
      </P>
      <H3>THIRD-PARTY LINKS AND CONTENT</H3>
      <P>
        The site and apps display links and content to third-party sites. These have their own
      ...
      <P>
        By using the app or site and providing your information, you authorize us to collect, use,
